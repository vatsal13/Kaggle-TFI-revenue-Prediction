...
def data_format_1(glob_train, glob_test):
	loc_train = glob_train.copy(deep = True)
	loc_test = glob_test.copy(deep = True)
	cont_features = loc_train.columns[loc_train.dtypes != 'object']
...
def data_format_4(glob_train, glob_test):
	...
	loc_train = data_format_3_res['train'].drop(['month_opened'], axis=1)
	loc_test = data_format_3_res['test'].drop(['month_opened'], axis=1)
...
def data_format_5(glob_train, glob_test):
	...
	data_format_4_res = data_format_4(glob_train, glob_test)
	loc_train = data_format_4_res['train'].drop(['P14','P15','P16','P17','P18','P24','P25','P26','P27','P30','P31','P32','P33','P34','P35','P36','P37'], axis=1)
	loc_test = data_format_4_res['test'].drop(['P14','P15','P16','P17','P18','P24','P25','P26','P27','P30','P31','P32','P33','P34','P35','P36','P37'], axis=1)
